...
<body>
	<div class="md:container md:mx-auto space-y-6 font-mono">
		...
		<div><a href="https://github.com/MeharmeetKaur/To-Do-List" class="hover:animate-ping" style="float: right;"><img style="margin-top:0.12em;margin-right:0.12em; " width="50" height="50" src="git.png"></a></div>
		</div>
		</div>
